...
{
       0,     0,     3,     4,     7,    11,    13,    19,    25,    30
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      11,     0,    -1,    -1,    11,     9,    -1,    11,    12,     9,
      -1,     3,    -1,     6,     3,     3,     3,     3,    -1,     4,
       3,     3,     3,     3,    -1,     5,     3,     3,     3,    -1,
       7,     3,    -1
};
...
static const char *const yytname[] =
{
  ...
  "RECTANGULO", "COLOR", "PRINT", "';'", "$accept", "list", "inst", 0
};
#endif
...
#line 42 "forma.y"
    { 
        ...
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(2) - (5)]).obj).simb); 
        //Push del segundo símbolo gramatical   (   Y   )
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(3) - (5)]).obj).simb); 
        //Push del tercer símbolo gramatical        ( ancho )
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(4) - (5)]).obj).simb); 
        //Push del cuarto símbolo gramatical        ( alto )
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(5) - (5)]).obj).simb); 
        maq.code("rectangulo");
    }
    break;
...
#line 72 "forma.y"
    { 
        ...
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(2) - (4)]).obj).simb); 
        //Push del segundo símbolo gramatical   (   X   )
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(3) - (4)]).obj).simb); 
        //Push del tercer símbolo gramatical        (   Y   )
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(4) - (4)]).obj).simb); 
        maq.code("circulo");
    }
    break;
...
#line 84 "forma.y"
    { 
        maq.code("constpush");
        maq.code(((Algo)(yyvsp[(2) - (2)]).obj).simb); 
        maq.code("color");
    }
    break;
