...
public final static short CILINDRO=258;
public final static short ESFERA=259;
public final static short CUBO=260;
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,"NUMBER","CILINDRO","ESFERA","CUBO","RECTANGULO","COLOR",
"PRINT","IMAGEN","FILTRO",
};
...
"inst : NUMBER",
"inst : RECTANGULO",
"inst : CILINDRO NUMBER NUMBER NUMBER NUMBER",
"inst : CUBO NUMBER",
"inst : ESFERA NUMBER",
"inst : COLOR NUMBER",
...
{ 
           (new Cilindro(
          ((Algo)val_peek(3).obj).simb.val, ((Algo)val_peek(2).obj).simb.val, 
          ((Algo)val_peek(1).obj).simb.val, ((Algo)val_peek(0).obj).simb.val)).dibujar(scene, a1);
      }
break;
case 7:
//#line 46 "forma.y"
{        
          (new Cubo(0.01, 0.01, 0.01, ((Algo)val_peek(0).obj).simb.val)).dibujar(scene, a1);
      }
break;
case 8:
//#line 49 "forma.y"
{ 
          (new Esfera(0.01, 0.01, 0.01, ((Algo)val_peek(0).obj).simb.val)).dibujar(scene, a1);
       }
break;
case 9:
//#line 52 "forma.y"
