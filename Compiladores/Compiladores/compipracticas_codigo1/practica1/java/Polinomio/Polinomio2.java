...
Polinomio mcd(Polinomio b) {
    Polinomio a, temp;
    int expo, coefi;
    System.out.println("expo " + b.grado());
    a = this;
    ...
    while (!((expo == 0 ) && (coefi == 0)) ){
        ...
        a = b;
        b = temp;
        /*System.out.println("MCD1 a");
        a.imprime();
        System.out.println("MCD1 ant b");
        b.imprime();
        System.out.println("expo MCD1 des b");
        System.out.println("7777pixa expo " + b.grado());*/
        //printf("expo=%d coefi=%d ", b->grado, b->Cfts[b->grado]);
        expo = b.grado(); coefi = b.coefis[b.grado()];
    }
    //System.out.println("DDDDDDDdesp while gra "+ a.grado());
    //a.imprime();
    return a;
}
